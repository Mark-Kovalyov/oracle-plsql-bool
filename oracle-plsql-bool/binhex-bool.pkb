...
CREATE OR REPLACE PACKAGE BODY BINHEX_BOOL AS
  ...
  FUNCTION XOR_PAD$(A IN VARCHAR2,B IN VARCHAR2,L IN PLS_INTEGER) RETURN VARCHAR2
  IS
    I   PLS_INTEGER;
    AI  PLS_INTEGER;
    BI  PLS_INTEGER;
  ...
  BEGIN
    ...
    MX := MAX$(LA, LB);
    IF LA>LB THEN 
      RETURN XOR_PAD$(A,LPAD(B,MX,'0'),MX);
    ELSIF LA<LB THEN
      RETURN XOR_PAD$(LPAD(A,MX,'0'),B,MX);
    ELSE
      RETURN XOR_PAD$(A,B,MX);
    END IF;
  END;

  FUNCTION OR_PAD$(A IN VARCHAR2,B IN VARCHAR2,L IN PLS_INTEGER) RETURN VARCHAR2
  IS
    I   PLS_INTEGER;
    AI  PLS_INTEGER;
    BI  PLS_INTEGER;
  ...
  BEGIN
    ...
    MX := MAX$(LA, LB);
    IF LA>LB THEN 
      RETURN OR_PAD$(A,LPAD(B,MX,'0'),MX);
    ELSIF LA<LB THEN
      RETURN OR_PAD$(LPAD(A,MX,'0'),B,MX);
    ELSE
      RETURN OR_PAD$(A,B,MX);
    END IF;
  END;
